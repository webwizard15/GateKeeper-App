...
import '../AdminScreens/complaint_screen.dart';


class ResidentsComplaintsLog extends StatefulWidget {
  const ResidentsComplaintsLog({super.key});

  @override
  State<ResidentsComplaintsLog> createState() => _ResidentsComplaintsLogState();
}

class _ResidentsComplaintsLogState extends State<ResidentsComplaintsLog> {
  int myIndex = 0;
  String? societyId;
  String? towerName;
  String? flatNumber;
  ...
  void initializeData() async {
    ...
    String? residentId = (await SharedPreferences.getInstance()).getString("userId");
    DocumentSnapshot doc = await FirebaseFirestore.instance.collection("resident").doc(residentId).get();
