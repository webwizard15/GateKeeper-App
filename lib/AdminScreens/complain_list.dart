...
class _ComplaintsLogState extends State<ComplaintsLog> {
  ...
  void initializeData() async {
    String? userSocietyId = (await SharedPreferences.getInstance()).getString("societyId");
    setState(() {
              ...
              itemBuilder: (context, index) {
                ...
                return Padding(
                  ...
                  child: Material(
                    ...
                    child: ListTile(
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context) => AdminComplaintScreen(title: complaintTitle, description: complaint, photo: image, id:complaintId,),));
                      },
                      leading: Container(
                        width: 50,
                        height: 50,
